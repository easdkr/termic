// Move keyboard focus to a tab's terminal. Termic prefers its own
// `.termic-terminal-input` IME-safe proxy and falls back to xterm's
// helper textarea for older mounted terminals; every terminal-tab host carries a
...
// tries ≈ frames: a fresh tab's terminal input isn't in the DOM
