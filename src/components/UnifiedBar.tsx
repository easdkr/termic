      ...
      {open && (
        ...
        >
          ...
          {/* One-time tip: agent CLIs persist their own theme. We set
              ...
              kimi / opencode / codex also expose a `/theme` slash command that
              writes to ~/.claude / ~/.kimi / ~/.opencode / ~/.codex - persists
          ...
          <div className="mt-1 border-t border-[var(--color-border-soft)] px-2 py-1.5 text-[11.5px] leading-snug text-[var(--color-fg-faint)]">
            Tip: run <span className="mono text-[var(--color-fg-dim)]">/theme</span> inside claude / codex / kimi / opencode once to match. The setting persists.
          </div>
        </div>
      )}
    </div>
