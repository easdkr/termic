...
//
// Built-in agents (claude/codex/agy/kimi/opencode) are editable but not removable —
...
export function AgentsSection() {
  ...
  async function resetAllBuiltins() {
    const ok = await useUI.getState().askConfirm({
      ...
      message: "Resets the built-in agents (claude, codex, Antigravity, kimi, opencode, cursor) to their ship-default commands. Custom agents and per-agent env blocks are kept.",
